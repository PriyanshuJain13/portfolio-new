      ...
      <div className="w-full space-y-2 flex flex-row mt-8 flex-wrap sm:space-y-0 sm:justify-between">
        ...
        <div className="blackBox w-full sm:w-1/3 xl:w-1/2 h-60 p-4 space-y-6 lg:space-y-2">
          <div className="flex justify-evenly h-2/3 space-x-4 xl:space-x-16">
            <a href="https://www.linkedin.com/in/priyanshu-jain-637406214" className="flex flex-between" target="_blank">
              <Image
                src={linkedIn}
                alt="logo"
            ...
            <a href="https://github.com/PriyanshuJain13" className="flex flex-between" target="_blank">
              <Image
                src={github}
                alt="logo"
            ...
            <a href="https://leetcode.com/pjrise13/" className="flex flex-between" target="_blank">
              <Image
                src={leetcode}
                alt="logo"
            ...
            <a href="https://codeforces.com/profile/priyAnshu.13" className="flex flex-between" target="_blank">
              <Image
                src={codeforces}
                alt="logo"
